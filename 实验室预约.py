...
wd.get('http://172.19.231.2:10102/login.html#/')#打开网址
element=wd.find_element_by_css_selector('[placeholder="请输入登录账号"]')
element.send_keys('666666')
element = wd.find_element_by_css_selector('[placeholder="请输入登录密码"]')
element.send_keys('666666')
time.sleep(1)
wd.find_element_by_css_selector('.normal-wrapper>button').click()#点击登录
